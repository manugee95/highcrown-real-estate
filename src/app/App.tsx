...
import {
  Menu, X, ChevronDown, ChevronUp, Facebook, Instagram, Linkedin,
  MessageCircle, TrendingUp, Users, Target, Zap, BarChart,
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              <button onClick={() => scrollToSection('home')} className="text-[#0F172A] hover:text-[#DC2626] transition-colors cursor-pointer">Home</button>
              <button onClick={() => scrollToSection('services')} className="text-[#0F172A] hover:text-[#DC2626] transition-colors cursor-pointer">Services</button>
              <button onClick={() => scrollToSection('packages')} className="text-[#0F172A] hover:text-[#DC2626] transition-colors cursor-pointer">Packages</button>
              <button onClick={() => scrollToSection('portfolio')} className="text-[#0F172A] hover:text-[#DC2626] transition-colors cursor-pointer">Portfolio</button>
              <button onClick={() => scrollToSection('faq')} className="text-[#0F172A] hover:text-[#DC2626] transition-colors cursor-pointer">FAQ</button>
              <button onClick={() => scrollToSection('contact')} className="text-[#0F172A] hover:text-[#DC2626] transition-colors cursor-pointer">Contact</button>
              <button
          ...
          {isMenuOpen && (
            ...
            >
              <button onClick={() => scrollToSection('home')} className="block w-full text-left py-2 text-[#0F172A] hover:text-[#DC2626]">Home</button>
              <button onClick={() => scrollToSection('services')} className="block w-full text-left py-2 text-[#0F172A] hover:text-[#DC2626]">Services</button>
              <button onClick={() => scrollToSection('packages')} className="block w-full text-left py-2 text-[#0F172A] hover:text-[#DC2626]">Packages</button>
              <button onClick={() => scrollToSection('portfolio')} className="block w-full text-left py-2 text-[#0F172A] hover:text-[#DC2626]">Portfolio</button>
              <button onClick={() => scrollToSection('faq')} className="block w-full text-left py-2 text-[#0F172A] hover:text-[#DC2626]">FAQ</button>
              <button onClick={() => scrollToSection('contact')} className="block w-full text-left py-2 text-[#0F172A] hover:text-[#DC2626]">Contact</button>
              <button
                onClick={() => scrollToSection('calendly')}
      ...
      {/* Hero Section */}
      <section id="home" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-red-50 to-orange-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#0F172A] leading-tight mb-6">
                Get More Qualified Property Leads and Close More Real Estate Deals Without Chasing Prospects
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Highcrown Digital Hub helps real estate businesses attract high-quality buyers through Facebook advertising, conversion-focused landing pages, websites, and WhatsApp automation.
              </p>
            ...
            >
              <div className="bg-white rounded-2xl shadow-2xl p-6 space-y-4">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-2xl font-bold text-[#0F172A]">Lead Dashboard</h3>
                  <div className="bg-green-100 text-green-700 px-4 py-2 rounded-lg">Live</div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-4 mt-6">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-green-600">Updated 2 min ago</span>
                  </div>
                  <div className="space-y-2">
                    {['New inquiry: 3BR Apartment', 'WhatsApp: Schedule viewing', 'Lead: Luxury Villa Interest'].map((item, i) => (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-6">
              Book a 30-minute strategy call and discover the biggest opportunities to increase your property inquiries.
            </p>
            <button
              onClick={() => scrollToSection('calendly')}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Users, title: 'Low Quality Leads', desc: 'Spending money on ads but getting unqualified prospects' },
              { icon: TrendingUp, title: 'Poor Website Conversion', desc: 'Visitors leave without taking action' },
              { icon: Clock, title: 'Slow Response Time', desc: 'Missing opportunities while leads go cold' },
              { icon: MessageCircle, title: 'Manual Follow-Up', desc: 'Wasting hours chasing leads manually' },
              { icon: Target, title: 'Wasted Ad Spend', desc: 'Burning budget without measurable results' },
              { icon: BarChart, title: 'Unpredictable Lead Flow', desc: 'Inconsistent pipeline makes growth impossible' }
            ].map((problem, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#0F172A] mb-2">{problem.title}</h3>
      ...
      {/* Solution Section */}
      <section id="solution" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-50 to-orange-50">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-[#0F172A] mb-4">
              How Highcrown Digital Hub Helps You Generate More Property Inquiries
            </h2>
          </motion.div>
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {[
                { step: 1, title: 'Attract Qualified Buyers', desc: 'Precision-targeted Facebook ads that reach property buyers actively searching in your area', icon: Target },
                { step: 2, title: 'Convert Visitors Into Leads', desc: 'High-converting landing pages designed specifically for real estate lead capture', icon: Globe },
                { step: 3, title: 'Automate Follow-Up Through WhatsApp', desc: 'Instant automated responses keep leads engaged while you focus on closing deals', icon: MessageCircle },
                { step: 4, title: 'Close More Deals', desc: 'Organized pipeline and automated nurture sequences turn prospects into buyers', icon: CheckCircle }
              ].map((item, index) => (
                <motion.div
                  key={index}
                ...
                >
                  ...
                  <div className={`hidden lg:flex justify-center ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
      ...
      <section id="services" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Globe, title: 'Landing Page Design', desc: 'High-converting pages built to capture real estate leads' },
              { icon: Smartphone, title: 'Website Development', desc: 'Professional websites that showcase your properties' },
              { icon: Facebook, title: 'Facebook Lead Generation', desc: 'Targeted ad campaigns that bring qualified buyers' },
              { icon: MessageCircle, title: 'WhatsApp Automation', desc: 'Instant follow-up that never misses a lead' },
              { icon: LineChart, title: 'Conversion Optimization', desc: 'Data-driven improvements to maximize ROI' },
              { icon: Settings, title: 'Funnel Setup', desc: 'Complete lead generation systems from ad to sale' }
            ].map((service, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
      ...
      {/* Packages Section */}
      <section id="packages" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-50 to-orange-50">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <h3 className="text-3xl font-bold text-[#0F172A] mb-4">Standard Package</h3>
              <div className="mb-8">
            ...
            >
              ...
              <div className="mb-8">
                <div className="text-white/90 mb-6">Complete growth solution</div>
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Target, title: 'Industry-Focused', desc: 'We specialize exclusively in real estate marketing and understand your unique challenges' },
              { icon: TrendingUp, title: 'Lead Generation First', desc: 'Every strategy is designed to generate qualified property inquiries and sales' },
              { icon: Zap, title: 'Automation Driven', desc: 'WhatsApp and CRM automation ensures no lead ever falls through the cracks' },
              { icon: Award, title: 'Results Oriented', desc: 'We measure success by your ROI, not vanity metrics' }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-50 to-orange-50">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            {[
              {
                ...
                name: 'David Okafor',
                position: 'CEO, Prime Properties Ltd',
                review: 'Highcrown transformed our lead generation completely. We went from 10 inquiries per month to over 150 qualified leads. The WhatsApp automation alone saves us 20 hours weekly.'
              },
              {
              ...
              },
              {
                ...
                review: 'Best investment we made this year. Their team understands real estate marketing inside out. Our property inquiries tripled and sales are up 65%.'
              }
              ...
              >
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="text-[#F59E0B] fill-current" size={20} />
                  ))}
                </div>
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-50 to-orange-50">
              ...
              >
                ...
                >
                  ...
                  {activeAccordion === index ? (
                    <ChevronUp className="text-[#DC2626] flex-shrink-0" size={24} />
                  ) : (
                    <ChevronDown className="text-[#DC2626] flex-shrink-0" size={24} />
                  )}
                </button>
                {activeAccordion === index && (
                  <motion.div
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-95">
              Let's build a predictable lead generation system that helps your real estate business attract, convert, and close more prospects.
            </p>
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-lg">
              <Shield className="text-white" size={24} />
              <span>100% Free Strategy Call • No Obligation</span>
            </div>
          </motion.div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                {/* <div className="text-2xl font-bold text-gray-700 mb-2">Calendly Integration</div> */}
                <div className="text-gray-600 mb-4">Book Your Free Strategy Call</div>
                {/* <div className="text-sm text-gray-500">
                  Replace this div with your Calendly embed code:<br/>
                  https://calendly.com/your-link
                </div> */}
                <div
                  className="calendly-inline-widget"
                  data-url="https://calendly.com/manugeetech/30min"
      ...
      {/* Footer */}
      <footer id="contact" className="bg-[#000000] text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-white/10 hover:bg-[#DC2626] rounded-full flex items-center justify-center transition-colors">
                  <Facebook size={20} />
                </a>
                <a href="#" className="w-10 h-10 bg-white/10 hover:bg-[#DC2626] rounded-full flex items-center justify-center transition-colors">
                  <Instagram size={20} />
                ...
                <a href="#" className="w-10 h-10 bg-white/10 hover:bg-[#F59E0B] rounded-full flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><button onClick={() => scrollToSection('packages')} className="text-gray-400 hover:text-white transition-colors">Packages</button></li>
